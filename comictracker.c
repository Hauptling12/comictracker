...
int main(int argc, char **argv)
{
    ...
    char extq[100] = "/.local/share/comictracker/comic.json";
    ...
    while ((c = getopt(argc, argv, "halv")) != -1) {
        ...
        case 'h':
            ...
            break;
        case 'l':
            system("cat ~/.local/share/comictracker/comic.json | jtbl");
            break;
        case 'a':
            printf("title: ");
            scanf("%[^\n]%*c",name);
            ...
            json_object_object_add(paige, "issues", json_object_new_string(issue));
